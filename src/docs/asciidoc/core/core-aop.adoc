...
.Java
----
	public class com.zero.st002.Main {
...
of the `com.zero.st002.Main` class has a reference to the proxy. This means that method calls on that
...
----
	...
	public final class com.zero.st002.Main {

		public static void main(String[] args) {
			ApplicationContext ctx = new ClassPathXmlApplicationContext("beans.xml", com.zero.st002.Main.class);
...
We use the following command to run the `com.zero.st002.Main` class shown earlier:

[literal,subs="verbatim,quotes"]
----
java -javaagent:C:/projects/foo/lib/global/spring-instrument.jar foo.com.zero.st002.Main
----
...
The output from the execution of the `com.zero.st002.Main` program looks something like the next example.
...
Spring beans. The following slight variation on the `com.zero.st002.Main` program yields the same
result:
...
----
	...
	public final class com.zero.st002.Main {
		...
		public static void main(String[] args) {
			new ClassPathXmlApplicationContext("beans.xml", com.zero.st002.Main.class);
