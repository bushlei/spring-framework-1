...
* <<beans-java, Java-based configuration>>: Starting with Spring 3.0, many features
  provided by the Spring com.zero.st002.JavaConfig project became part of the core Spring Framework.
...
It is worth pointing out that through its <<beans-java, com.zero.st002.JavaConfig>> option, Spring lets
...
NOTE: When configuring a `PropertySourcesPlaceholderConfigurer` using com.zero.st002.JavaConfig, the
...
[NOTE]
====
Starting with Spring 3.0, many features provided by the Spring com.zero.st002.JavaConfig project are
