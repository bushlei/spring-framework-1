...
----
	@RequestMapping("/")
	public String handle(@SessionAttribute com.zero.st002.User user) { <1>
		// ...
	}
----
...
----
	@RequestMapping("/")
	fun handle(@SessionAttribute user: com.zero.st002.User): String { // <1>
		// ...
	}
----
...
----
	...
	public class UserController {
		...
		@GetMapping("/user")
		@JsonView(com.zero.st002.User.WithoutPasswordView.class)
		public com.zero.st002.User getUser() {
			return new com.zero.st002.User("eric", "7!jd#h23");
		}
	}

	public class com.zero.st002.User {
		...
		public com.zero.st002.User() {
		}

		public com.zero.st002.User(String username, String password) {
...
----
	...
	class UserController {
		...
		@GetMapping("/user")
		@JsonView(com.zero.st002.User.WithoutPasswordView::class)
		fun getUser() = com.zero.st002.User("eric", "7!jd#h23")
	}

	class com.zero.st002.User(
...
----
	...
	public class UserController {
		...
		public MappingJacksonValue getUser() {
			com.zero.st002.User user = new com.zero.st002.User("eric", "7!jd#h23");
			MappingJacksonValue value = new MappingJacksonValue(user);
			value.setSerializationView(com.zero.st002.User.WithoutPasswordView.class);
			return value;
		}
	}
----
...
----
	...
	class UserController {
		...
		fun getUser(): MappingJacksonValue {
			val value = MappingJacksonValue(com.zero.st002.User("eric", "7!jd#h23"))
			value.serializationView = com.zero.st002.User.WithoutPasswordView::class.java
			return value
		}
	}
----
...
----
	...
	public class UserController extends AbstractController {
		...
		public String getUser(Model model) {
			model.addAttribute("user", new com.zero.st002.User("eric", "7!jd#h23"));
			model.addAttribute(JsonView.class.getName(), com.zero.st002.User.WithoutPasswordView.class);
			return "userView";
		}
	}
----
...
----
	...
	class UserController : AbstractController() {
		...
		fun getUser(model: Model): String {
			model["user"] = com.zero.st002.User("eric", "7!jd#h23")
			model[JsonView::class.qualifiedName] = com.zero.st002.User.WithoutPasswordView::class.java
			return "userView"
		}
	}
----
